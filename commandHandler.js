...
async function setupCommands(client) {
    ...
    const selfieCommandHandler = new SelfieCommandHandler(creditManager); // Instantiate SelfieCommandHandler
    ...
    // Removed ImagineCommand from commandMap
    commandMap.set(selfieCommandHandler.getCommandData().name, selfieCommandHandler); // Add SelfieCommandHandler to commandMap
